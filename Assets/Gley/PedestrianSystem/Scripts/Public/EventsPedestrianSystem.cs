...
namespace Gley.PedestrianSystem
{
    public class Events
    {
        ...
        public delegate void StreetCrossing(int pedestrianIndex, IIntersection intersection, int waypointIndex);
        public static StreetCrossing OnStreetCrossing;
        public static void TriggerStreetCrossingEvent(int pedestrianIndex, IIntersection intersection, int waypointIndex)
        {
