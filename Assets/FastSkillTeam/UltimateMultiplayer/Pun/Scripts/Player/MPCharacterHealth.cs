/////////////////////////////////////////////////////////////////////////////////
//
//  MPCharacterHealth.cs
//  @ FastSkillTeam Productions. All Rights Reserved.
//  http://www.fastskillteam.com/
//  https://twitter.com/FastSkillTeam
//  https://www.facebook.com/FastSkillTeam
//
//	Description:	Redesigned character health for Master Syncing only.
//
/////////////////////////////////////////////////////////////////////////////////
...
namespace FastSkillTeam.UltimateMultiplayer
{
    ...
    public class MPCharacterHealth : MPHealth
    {
        ...
        protected override void Awake()
        {
            if (!CharacterInitializer.AutoInitialization)
            {
                ...
                CharacterInitializer.Instance.OnStart += StartInternal;
                return;
            }
        ...
        {
            if (CharacterInitializer.Instance)
            {
                CharacterInitializer.Instance.OnAwake -= AwakeInternal;
            }
        ...
        private void StartInternal()
        {
            ...
            {
                m_DamagedEffect = m_CharacterLocomotion.GetEffect(Opsive.Shared.Utility.TypeUtility.GetType(m_DamagedEffectName), m_DamagedEffectIndex);
            }
        }
        ...
        public override void Die(Vector3 position, Vector3 force, GameObject attacker)
        {
            ...
            {
                Debug.Log("CharacterHealth.Die(): was called on an inactive player: " + this.gameObject);
                return;
            }
        ...
        private void OnCharacterLand(float fallHeight)
        {
            ...
            // Apply the damage.
            // NOTE: Falling is a special case, Falling on a client will only show the effects as it only happens locally.
            ...
            MPLocalPlayer.Damage(damageAmount, m_Transform.position,Vector3.zero,0,m_GameObject);
