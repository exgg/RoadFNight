...
//
//	Description:	Redesigned health for Master Syncing only.
//
/////////////////////////////////////////////////////////////////////////////////

namespace FastSkillTeam.UltimateMultiplayer
{
    ...
    public class MPHealth : StateBehavior, IDamageTarget
    {
        ...
        public Attribute ShieldAttribute => m_ShieldAttribute;
        public Attribute HealthAttribute => m_HealthAttribute;
        // cache of known Health components, stored by collider (for optimization)
        protected static Dictionary<Collider, MPHealth> m_Instances = null;
        public static Dictionary<Collider, MPHealth> Instances
        {
            get
            {
                if (m_Instances == null)
                    m_Instances = new Dictionary<Collider, MPHealth>(100);
                return m_Instances;
            }
        }
        ...
        protected override void Awake()
        {
            ...
            if (!Instances.ContainsKey(GetComponentInChildren<Collider>()))
                Instances.Add(GetComponentInChildren<Collider>(), this);
        }
        /// <summary>
        ...
        public virtual void OnDamage(DamageData damageData)
        {
            ...
            if (m_ShieldAttribute != null && m_ShieldAttribute.Value > m_ShieldAttribute.MinValue)
            {
                ...
                if (m_NetworkInfo == null || m_NetworkInfo != null && m_NetworkInfo.IsServer())
            ...
            {
                EventHandler.ExecuteEvent<Transform, DamageData>("TransmitDamage", m_Transform, damageData);
            }
        ...
        {
            m_HealthAttribute.Value = 0;//NOTE: MAKE SERVER ONLY, with its check.
            ...
            if (m_NetworkInfo != null)
                EventHandler.ExecuteEvent<Transform, Vector3, Vector3, GameObject>("TransmitKill", m_Transform, position, force, attacker);
        ...
        public bool Heal(float amount)
        {
            ...
            if (m_NetworkInfo != null && m_NetworkInfo.IsServer())
            {
                EventHandler.ExecuteEvent<Transform>("TransmitHeal", m_Transform);
            }
