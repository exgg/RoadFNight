...
//
//	Description:	3D utility functions designed for use with multiplayer
//
/////////////////////////////////////////////////////////////////////////////////
...
namespace FastSkillTeam.UltimateMultiplayer.Pun.Utility
{
	...
	public static class MP3DUtility
	{
		...
		public static GameObject DebugPrimitive(PrimitiveType primitiveType, Vector3 scale, Color color, Vector3 pivotOffset, Transform parent = null)
		{
			...
			FastSkillTeam.Shared.Utility.MaterialUtility.MakeMaterialTransparent(mat);
			mat.color = color;
